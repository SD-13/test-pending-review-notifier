...
def send_notification(username, pull_requests, org_name, repo, test_mode):
    ...
    body = "test comment generated by workflow action for testing purposes"
...
def main(args=None):
    ...
    # changing it for testing purpose
    org_name = 'oppia'
    repo = 'oppia'
